...
export function getDetailReformPaperInfo(id) {
  return request({
    url: '/normal/reform_paper/detail',
    method: 'post',
    data: {
      id: id
    }
...
//添加论文信息
export function createItemInfo(order,paper_name,paper_number,journal_name,
                               publish_year_month,journal_year,journal_number,
                               journal_volum,source_project,
                               cover_path,content_path,text_path,cnki_url,
                               participate_teacher) {
  return request({
    url: '/normal/reform_paper/create',
    method: 'post',
    data: {
      order: order,
...
export function changeSubmitInfo(id,order,paper_name,paper_number,journal_name,
                                 ...
                                 participate_teacher ) {
  return request({
    url: '/normal/reform_paper/submitInfo/change',
    method: 'post',
    data: {
      id: id,
      order: order,
...
export function reformPaperChangeStatus(id, status) {
  return request({
    url: '/normal/reform_paper/changestatus',
    method: 'post',
    data: {
      id: id,
      status: status
...
export function statusSearchReformPaper(status) {
  return request({
    url: '/normal/reform_paper/status_search',
    method: 'post',
    data: {
      token: store.getters.token,
      status: status
...
export function searchReformPaperInfo(search_type, search_value) {
  return request({
    url: '/normal/reform_paper/search',
    method: 'post',
    data: {
      token: store.getters.token,
