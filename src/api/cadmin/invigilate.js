...
export function statusSearchInvigilate(status) {
  return request({
    url: '/cadmin/invigilate/status_search',
    method: 'post',
    data: {
      token: store.getters.token,
      status: status
...
export function changeInvigilateStatus(id,status) {
  return request({
    url: '/cadmin/invigilate/changestatus',
    method: 'post',
    data: {
      id: id,
      status: status
...
export function changeSubmitInfo(id, subject, semester_id, _class, exam_time, location, participate_teacher, ) {
  return request({
    url: '/cadmin/invigilate/submitInfo/change',
    method: 'post',
    data: {
      id: id,
      subject: subject,
