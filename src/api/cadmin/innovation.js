...
export function statusSearchInnovation(status) {
  return request({
    url: '/cadmin/innovation/status_search',
    method: 'post',
    data: {
      token: store.getters.token,
      status: status
...
export function changeInnovationStatus(id,status) {
  return request({
    url: '/cadmin/innovation/changestatus',
    method: 'post',
    data: {
      id: id,
      status: status
...
export function changeSubmitInfo(id, project_name, project_number, rank_id,
                                 ...
                                 subject, status, host_student, participant_student, remark) {
  return request({
    url: '/cadmin/innovation/submitInfo/change',
    method: 'post',
    data: {
      id: id,
