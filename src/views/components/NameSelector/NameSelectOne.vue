<!--
【名称按照字母分类组件---选择一个名称】<通用版本！！>

使用说明：
eg.：<name-select-one list_title="教师姓名" tips="想要提示的内容" :name_list_array="name_list" v-model="select_name"></name-select-one>

:param list_title [String] “列表标题” eg. list_title="教师姓名"

:param tips [String] “想要提示的内容” eg. tips="这个表单只能选一个名字"

:param name_list_array [array] “姓名数组” eg. name_list = [ "张三","李四","王五","冯六","陈七" ]

:param value [String] “v-model绑定返回的结果” eg. select_name = "王五"
-->

<template>
  <div >

    <el-input @focus="show_drop = true" v-model="value" @change="handleInputChange" style="width: 200px" clearable></el-input>
